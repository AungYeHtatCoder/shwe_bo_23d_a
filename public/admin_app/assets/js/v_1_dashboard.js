var ctx1 = document.getElementById("chart-line-3d").getContext("2d");
var ctx2 = document.getElementById("chart-pie-3d").getContext("2d");
//var ctx3 = document.getElementById("chart-bar").getContext("2d");

// Fetch monthly totals
async function fetchMonthlyTotals() {
  const response = await fetch("/admin/threed-lotteries-daily-income-monthly");
...
$(document).ready(function () {
  ...
  $.get("/admin/threed-lotteries-daily-income-money", function (response) {
...
async function fetchDailyTotals() {
  const response = await fetch("/admin/threed-lotteries-daily-income");
  const data = await response.json();
...
async function renderChart() {
  ...
  var ctx = document.getElementById("chart-bars-3d").getContext("2d");
