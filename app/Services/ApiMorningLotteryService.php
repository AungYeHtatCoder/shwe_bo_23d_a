...
class ApiMorningLotteryService
{
    /**
     ...
     */
    public function getAuthUserTodayMorning()
    {
        ...
        $isMorningSession = ($currentTime >= '04:00:00' && $currentTime <= '12:01:00');
        ...
        // return DB::table('lottery_two_digit_pivot')
        //     ->join('lotteries', 'lottery_two_digit_pivot.lottery_id', '=', 'lotteries.id') // Ensure lotteries is joined
