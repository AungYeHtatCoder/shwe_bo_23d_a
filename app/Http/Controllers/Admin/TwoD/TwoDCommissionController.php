...
use App\Services\TwoDCommissionService;
...
class TwoDCommissionController extends Controller
{
    ...
    public function __construct(TwoDCommissionService $lotteryService)
    {
        $this->lotteryService = $lotteryService;
    }

    public function showTotalAmountByUser()
    {
        //$totalAmounts = $this->lotteryService->getTotalAmountByUser();
        ...
        return view('admin.two_d.commission.two_d_commission_index', compact('totalAmounts'));
    }
    public function show($id)
    {
        ...
        return view('admin.two_d.commission.two_d_commission_show', compact('lotto', 'user'));
    }
    ...
    public function TwoDtransferCommission(Request $request)
{
    ...
    try {
        ...
        // Transfer commission
        $user->cor += $validatedData['commission_amount'];
        $lotto->commission_amount -= $validatedData['commission_amount'];
