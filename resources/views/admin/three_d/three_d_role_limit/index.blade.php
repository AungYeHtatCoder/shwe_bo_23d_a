 ...
 <div class="col-12">
  <div class="card">
   ...
   <div class="card-header pb-0">
    <div class="d-lg-flex">
     <div>
      <h5 class="mb-0">3D Role Limit Dashboards</h5>
        ...
        <div class="modal-dialog mt-lg-10">
         <div class="modal-content">
          <div class="modal-header">
           <h5 class="modal-title" id="ModalLabel">Create New 3D Role Limit</h5>
           <i class="material-icons ms-3">file_upload</i>
           <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
           <p>You can create new role limit for all specific user.</p>
           <form class="multisteps-form__form" action="{{ route('admin.three-d-role-limits.store') }}" method="post">
            @csrf
    ...
    <table class="table table-flush" id="permission-search">
     ...
     <tbody>
      ...
      <td class="text-sm font-weight-normal">{{ $limit->role->title }}</td>
       ...
       <td>
        <a href="{{ route('admin.three-d-role-limits.edit', $limit->id) }}" data-bs-toggle="tooltip"
        ...
        <form class="d-inline" action="{{ route('admin.three-d-role-limits.destroy', $limit->id) }}" method="POST">
         @csrf
         @method('DELETE')
