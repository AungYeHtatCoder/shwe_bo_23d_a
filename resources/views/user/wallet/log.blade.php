...
<div class="">
    ...
    <h6 class="text-center mt-2 pb-2 text-purple">ငွေသွင်း/ထုတ်မှတ်တမ်း</h6>
      ...
      <div class="row pt-3 text-center">
        ...
        <div class="col">
          ...
          >
            ...
            <p style="font-size: 14px; margin-top: 10px;" class=" text-purple">မှတ်တမ်း</p>
          </a>
        </div>
      </div>
    </div>
    <div class="row mt-4 mb-3 mx-auto text-center">
      <div class="col-3">
        <small class=" text-purple">နေ့စွဲ</small>
      </div>
      <div class="col-3">
        <small class=" text-purple">အမျိုးအစား</small>
      </div>
      <div class="col-3">
        <small class=" text-purple">ပမာဏ</small>
      </div>
      <div class="col-3">
        <small class=" text-purple">အခြေအနေ</small>
      </div>
    </div> 
    @foreach ($logs as $log)
      <div class="row text-center mx-auto mb-2">
        <div class="col-3">
          <small class=" text-purple">{{ $log->created_at->format('j/m/Y') }}</small>
        </div>
        <div class="col-3">
          <small class=" text-purple">{{ $log->type == "Withdraw" ? "ထုတ်ငွေ" : "သွင်းငွေ" }}</small>
        </div>
        <div class="col-3">
          <small class=" text-purple">{{ number_format($log->amount) }} ကျပ်</small>
        </div>
        <div class="col-3">
